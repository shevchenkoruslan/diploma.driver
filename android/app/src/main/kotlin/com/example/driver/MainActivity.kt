...
class MainActivity: FlutterActivity() {
    private val methodChannelName: String = "com.example.driver.androidMethodChannel"
    private val eventChannelName: String = "com.example.driver.androidEventChannel"
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        methodChannel = MethodChannel(flutterEngine.getDartExecutor().getBinaryMessenger(), methodChannelName)
        methodChannel.setMethodCallHandler { methodCall, result ->    
            when(methodCall.method){
                "getSensorsList" -> {
                    eventChannel = EventChannel(flutterEngine.getDartExecutor().getBinaryMessenger(), eventChannelName)
